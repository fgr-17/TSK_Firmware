 ...
 * 	Archivo : strbus.h
 * 
 * 	Descripción: header del archivo strbus.h
 * 
...
//	uint8_t				frame_temp[LARGO_BUFFER_FRAME];
	...
	t_bool				envio_activado;												// Flag de envío
	...
	t_uframe			c_frame;													// Campos definidos en la estrura
...
extern int CopiarArray_8_bits(uint8_t* array_destino, const uint8_t* array_origen, uint16_t largo);
